...
validate_recipe_outputs "terraform-provider-heroku-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="terraform-provider-heroku-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi